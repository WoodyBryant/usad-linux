...
if __name__ == '__main__':
    # 下载正常数据 https://drive.google.com/open?id=1rVJ5ry5GG-ZZi5yI4x9lICB8VhErXwCw input/
    #下载异常数据 https://drive.google.com/open?id=1iDYc0OEmidN712fquOBRFjln90SbpaE7 input/
    # url = get_arg(1, '').strip()
